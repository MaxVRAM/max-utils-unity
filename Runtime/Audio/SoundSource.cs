...
namespace MaxVram.Audio
{
    ...
    public class SoundSource : IMakeSound
    {
        ...
        private float PreviousGain { get; set; }
        ...
        /// <summary>
        /// Fills the provided buffer with samples generated by this sound source, changing the gain over the buffer duration if required.
        /// </summary>
        ...
        public void FillBuffer(ref float[] buffer, int channels, float gain = 1f)
        {
            ...
            float gainDifference = gain - PreviousGain;
            
            if (gainDifference != 0)
            {
                gainIncrement = gainDifference / buffer.Length;
                gain = PreviousGain;
            }
